...
protocol AIProvider {
    ...
    func analyze(indicators: [IndicatorResult], sentiment: CoinInfo?, symbol: String, market: Market, stockInfo: StockInfo?, derivatives: DerivativesData?, positioning: PositioningSnapshot?, stockSentiment: StockSentimentData?, economicEvents: [EconomicEvent], macro: MacroSnapshot?) async throws -> ClaudeAnalysisResponse
}
