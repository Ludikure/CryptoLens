...
DOWNLOADS = '/tmp/retrain_stocks'  # v13: fresh node-CLI regen (2026-05-29)
...
STOCK_SYMBOLS = [
    ...
    # High-beta growth (SQ excluded — Yahoo ticker change to XYZ)
    ...
    # Cyclicals / industrials (X excluded — being acquired by Nippon Steel)
    'CAT', 'DE', 'BA',
...
def export_model(market, model, n_samples, x_cal, y_cal, is_lgb):
    ...
    m = {
        ...
        'description': f'v12 {market} ({model_type}) — goodR = fwdMaxFavR>=1.5, {n_samples} bars (lookahead-corrected stock features 2026-05-04)',
    }
    # Write to worker
...
if __name__ == '__main__':
    print("=" * 60)
    print("v13 — STOCKS (XGBoost d5 t100, /tmp/retrain_stocks 2026-05-29 regen)")
